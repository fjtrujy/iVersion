#
#  Be sure to run `pod spec lint iVersion.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "fjtrujy" => "email@address.com" }
  # Or just: s.author    = "fjtrujy"
  # s.authors            = { "fjtrujy" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/fjtrujy"
